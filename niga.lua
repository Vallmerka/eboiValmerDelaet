...
function InterfaceManager:ImportSettings()
    pcall(function()
        if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().isfile("UISettings.valmer") and getfenv().readfile("UISettings.valmer") then
            for Key, Value in next, HttpService:JSONDecode(getfenv().readfile("UISettings.valmer")) do
...
function InterfaceManager:ExportSettings()
    pcall(function()
        if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().writefile then
            getfenv().writefile("UISettings.valmer", HttpService:JSONEncode(UISettings))
        end
    end)
end
...
pcall(function()
    if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().isfile(string.format("%s.valmer", game.GameId)) and getfenv().readfile(string.format("%s.valmer", game.GameId)) and UISettings.AutoImport then
        ImportedConfiguration = HttpService:JSONDecode(getfenv().readfile(string.format("%s.valmer", game.GameId)))
...
do
    local Window = Fluent:CreateWindow({
        Title = "Valmer Delaet | v0.0.1-pre-alpha ♥ ",
        SubTitle = "By valmer",
    ...
    if getfenv().isfile and getfenv().readfile and getfenv().writefile and getfenv().delfile then
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    if getfenv().isfile(string.format("%s.valmer", game.GameId)) and getfenv().readfile(string.format("%s.valmer", game.GameId)) then
                        local ImportedConfiguration = HttpService:JSONDecode(getfenv().readfile(string.format("%s.valmer", game.GameId)))
                        for Key, Value in next, ImportedConfiguration do
                        ...
                        Window:Dialog({
                            ...
                            Content = string.format("Configuration File %s.valmer has been successfully loaded!", game.GameId),
                            Buttons = {
                                {
                                    Title = "Confirm"
                                }
                        ...
                        Window:Dialog({
                            Title = "Configuration Manager",
                            Content = string.format("Configuration File %s.valmer could not be found!", game.GameId),
                            Buttons = {
                                {
                                    Title = "Confirm"
                                }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when loading the Configuration File %s.valmer", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    ...
                    getfenv().writefile(string.format("%s.valmer", game.GameId), ExportedConfiguration)
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.valmer has been successfully overwritten!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when overwriting the Configuration File %s.valmer", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                if getfenv().isfile(string.format("%s.valmer", game.GameId)) then
                    getfenv().delfile(string.format("%s.valmer", game.GameId))
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.valmer has been successfully removed!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
...
local OnTeleport; OnTeleport = Player.OnTeleport:Connect(function()
    if DEBUG or not Fluent or not getfenv().queue_on_teleport then
        ...
        getfenv().queue_on_teleport("getfenv().loadstring(game:HttpGet(\"https://raw.githubusercontent.com/valmer/Open-Aimbot/master/source.lua\", true))()")
        OnTeleport:Disconnect()
    end
end)
